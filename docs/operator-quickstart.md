# Operator Quickstart — Tobacco Products Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 1200** (`cloud-itonami-isic-1200`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1200.git
cd cloud-itonami-isic-1200
```
...
- Blueprint governor key: `tobacco-manufacturing-governor`
- Likely source path: `tobaccomfg.governor.cljc`
